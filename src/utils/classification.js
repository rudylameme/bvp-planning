...
const motsCleBoulangerie = ['pain', 'baguette', 'mie', 'campagne', 'céréales', 'complet', 'tradition', 'ficelle'];
const motsCleViennoiserie = ['croissant', 'chocolat', 'chausson', 'brioche', 'pain raisin', 'pain au', 'viennois'];
...
export const classerProduit = (libelle) => {
  ...
  if (motsClePatisserie.some(mot => libelleLower.includes(mot))) return 'PÂTISSERIE';
